...
# --- CONFIGURATION FIXE DE L'AUTORITÉ 3 ---
AUTH_ID = "Auth3"
SECRETS_FILE = "secrets_Auth3.json"

intents = discord.Intents.default()
intents.message_content = True
# Ce bot répondra uniquement aux commandes commençant par "!auth3"
bot = commands.Bot(command_prefix="!auth3 ", intents=intents)
...
# Remplace par le Token du 3ème bot Discord
bot.run("")